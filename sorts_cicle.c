...
int main() {
  ...
  //FILE *file2;
  //FILE *file3;
  //file1 = fopen("radix.txt", "a+");
  //file2 = fopen("selection.txt", "a+");
  //file3 = fopen("heap.txt", "a+");
  printf("\n------------\n");
  //scanf("%d", &size);
  printf("------------\n");
  ...
  //double c = t2 - t1;
  //fwrite(&c, sizeof(double), 8, file1);
  //fprintf(file1, "%s", "\r\n");
  t1 = wtime();
  ...
  //c = t2 - t1;
  //fwrite(&c, sizeof(double), 8, file2);
  //fprintf(file2, "%s", "\r\n");
  printf("| |\n");
  t1 = wtime();
  heapSort(mas3, size);
  ...
  //c = t2 - t1;
  //fwrite(&c, sizeof(double), 8, file3);
  //fprintf(file3, "%s", "\r\n");
